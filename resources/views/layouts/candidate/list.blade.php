            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    ...
                    <span class="float-left"><h5><i class="fa fa-align-justify"></i>{{ __('Оролцогчид') }}</h5></span> <span class="float-right">
                    ...
                    <form action="{{ route('candidate.index')}}" method="GET" id="group">
                        <div class="form-group col-md-4">
                            ...
                            @foreach ($groups as $key)
                                <option @if($group_id==$key->id) {{ 'selected'}} @endif value="{{$key->id}}">{{$key->name }}</option>
                            @endforeach
                            </select>
                        </div>
                        <!-- <div class="form-group col-md-4">
                            ...
                            <tbody>
                                @if ($canditateList)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/candidate/assessments/{{$item->id}}" class="btn btn-primary" title="Өгсөн тестүүдийг харах"><i class="text-white cil-list-numbered"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                @endif
