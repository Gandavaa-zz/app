        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="group-header">
                    <h2 class="ec-title">{{ $item[1]["content"]["title"]}}</h2>
                    <figure class="highcharts-figure">
                        <div class="mb-3" id="barChart"></div>
                        <div style="height: 600px; width: 1288px; margin:0 auto" id="chart">
                        </div>
                    </figure>
    ...
    <div class="col-md-12" id="{{$item[5]["content"]["title"]}}">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @for($i = 7; $i < 25; $i++) @if(str_contains($item[$i]['type'], 'rapport_details_groupe' )) <div class="mt-4">
                    <div class="group-header">
                        <h3>{{ $item[$i]["content"]["title"] }}</h3>
                        <hr style="border-bottom:#{{$item[$i]['params']['couleur']}} 3px solid;border-top: none;">
                    </div>
                    ...
                    <div class="score-bar-wrapper row">
                        <div class="col-xs-12 col-sm-3 ">
                            <div class="box-score ec-first-bg-color ec-first-text-color " style="color:#000;background-color:#C0C0C0">
                                <div class="header" style="background:#{{$item[$i]['params']['couleur']}}">
                                    {{ __('Score') }}<br>
                    ...
                    <table class="b-table table table-hovered">
                        <tbody>
                            ...
                            @for ($i=0; $i < count($item[26]["adequacy"]); $i++) <tr>
                                ...
                                <td style="width: 25%">
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:{{str_replace(".", "", $item[26]["adequacy"][$i]['pourcentage_score'])}}%;">
                                        </div>
                                    </div>
