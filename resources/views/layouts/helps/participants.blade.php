            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fa fa-align-justify"></i>{{ __('Оролцогчид тусламж') }}</h5>
                    </div>
                    <div class="card-body">
                        
                        <div class="alert alert-info" role="alert"><b>"Оролцогчид нь Centraltest.com"-participants-ын утгуудыг татаж харуулж байгаа.</b></div>
                                                
                        <p>
                            <strong>Оролцогчид</strong> нь системийг бүхэлд нь удирдах удирлагатай холбоотой дараах <strong> Оролцогсод жагсаалт </strong>, <strong>Бүлэг</strong> гэсэн хэсгүүдээс бүрдэнэ.
                        </p>
                        <hr>
                        ...
                        <div class="nav-tabs-boxed pt-3">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home"
                                        role="tab" aria-controls="home"><strong>Оролцогчид</strong></a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#role" role="tab"
                                        aria-controls="profile"><strong>Бүлэг</strong></a></li>                                
                            </ul>
