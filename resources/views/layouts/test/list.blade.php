                ...
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">
                            <h5><i class="fa fa-align-justify"></i>{{ __('Тест') }}</h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/tests/{{$test->id}}/edit" class="btn btn-primary btn-sm"
                                            title="Edit"><i class="faы fa-pencil-alt"></i></a>
                                        <a href="#" class="btn btn-danger btn-sm" title="Edit"><i
