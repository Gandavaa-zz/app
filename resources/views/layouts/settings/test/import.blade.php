...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Тест XSL файлаас импортлох') }}</div>

                <div class="card-body">
           
                    <form method="POST" action="{{ route('test.importExcel') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">{{ __('Асуултын XLS файл') }}</label>
