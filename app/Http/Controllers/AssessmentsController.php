...
class AssessmentsController extends Controller
{
    ...
    */
    ...
    public function pdf()
    {
        ...
        // $pdf->generateFromHtml($html, '123.pdf');
        // $pdf->stream();        
        return PDF::loadFile('http://127.0.0.1:8000/assessment/report/9985448')->inline('github.pdf');
        // return PDF::loadHTML($html)->inline('test.pdf');
        // return PDF::loadFile($html)->inline('github.pdf');
        // return $pdf->stream();
    }
}
